<?php
$con = mysqli_connect("localhost","root","","bandar");
...
if(isset($_POST['sub'])) {
    ...
    if(empty($errors)){
        ...
        $sql = "INSERT INTO users (frist_name , last_name , email ) VALUES ('$fname' ,'$lname' , '$email') ";
...
if (isset($_POST['win'])) {
    ...
    echo "<script>alert('الفايز: $frist_name $last_name')</script>";
}
    ...
    <body>
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto ">
                <img id="tvtc" src="project.png" alt="">
                <h1 class="display-4 fw-normal mb-3">اربح مع نور</h1>
        ...
        <div class="position-relative text-center ">
            <div class="col-md-5 p-lg-5 mx-auto mt-1">
                <form action="" method="POST">
                    ...
                    <input type="submit" name="sub"  class="btn btn-primary" value="إرسال المعلومات">
                </form>
            </div>
        </div>
        ...
        <form action="" method="POST">
            <div id="formating" class="d-grid gap-2 col-6 mx-auto mb-5">
                <input type="submit" name='win' class="btn btn-primary" value=" أختيار الرابح">
            </div>
        </form>
        ...
        <script>
            var countDownDate = new Date("mar 7, 2023 23:59:00").getTime();
